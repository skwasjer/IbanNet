...
public class IsValidLengthRuleTests
{
    ...
    public void Given_value_of_invalid_length_when_validating_it_should_return_error(int count)
    {
        ...
        var context = new ValidationRuleContext(value)
        {
            ...
            {
                Iban = new PatternDescriptor(new TestPattern([new PatternToken(AsciiCategory.Digit, 10)]))
            }
        };
    ...
    public void Given_that_value_exceeds_max_length_when_validating_it_should_return_error()
    {
        ...
        var context = new ValidationRuleContext(value)
        {
            Country = new IbanCountry("XX")
            {
                Iban = new PatternDescriptor(new TestPattern([new PatternToken(AsciiCategory.Digit, 40)]))
            }
        };
